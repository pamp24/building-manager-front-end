...
export class CropperComponentComponent implements OnChanges, OnInit {
  ...
  private readonly hammerLoader = inject<HammerLoader | null>(HAMMER_LOADER, { optional: true });
  ...
  readonly sourceImage = viewChild.required<ElementRef<HTMLDivElement>>('sourceImage');
